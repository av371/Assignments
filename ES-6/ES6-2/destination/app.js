...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__class_js__ = __webpack_require__(1);
...
window.onload = function () {
  ...
  array["root"] = new __WEBPACK_IMPORTED_MODULE_0__class_js__["b" /* folder */]("root", "ssss", "root/");
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a("div").click(function (evt) {
    ...
    if (!clicked.innerHTML.includes(dot)) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default.a("#errors").show();
      document.getElementById("errors").innerHTML = "It's a file bro";
      setTimeout(function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#errors').fadeOut();
      }, 3000);
    }
  });
    ...
    if (name.includes(dot)) {
      ...
      if (fileName.length > 2) {
        ...
        if (validateProp1(fileName[0]) && validateProp1(fileName[1])) {
          if (hash[currentFolder] === undefined) {
            ...
            array[name] = new __WEBPACK_IMPORTED_MODULE_0__class_js__["a" /* file */](fileName[0], currentFolder, fileName[1], path);
            document.getElementById('root').innerHTML = showContents(currentFolder);
          } else {
      ...
      if (validateProp1(name)) {
        if (hash[currentFolder] === undefined) {
          ...
          names.push(name);
          const path = `${array[currentFolder].showPath()}${name}/`;
          array[name] = new __WEBPACK_IMPORTED_MODULE_0__class_js__["b" /* folder */](name, currentFolder, path);
          document.getElementById('root').innerHTML = showContents(currentFolder);
        } else {
          if (hash[currentFolder].indexOf(name) === -1) {
            hash[currentFolder].push(name);
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a("#button3").click(function () {
